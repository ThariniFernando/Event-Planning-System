...
<div class="form-frame">
        <div class="form-container">
            ...
            <form action="updatecusservlet" id="eventForm" method="post">
            <br><br><br><br><br><br><br>
            <div class="form-title">Book Your Event</div><br><br>
                <div class="form-group">
                Customer ID<input type="text" name="cusid" value="<%=id %>" readonly><br>
                <label for="username">User name</label>
                        <input class="input-box" type="text" id="username" name="username"  value="<%=name %>"><br><br>
                ...
                <div class="form-group">
                    ...
                    <input class="input-box" type="text" id="passengerCount" name="passengerCount" value="<%=pcount %>" >
                </div>
                <div class="form-group">
                    <label for="concerns">Customer Concerns</label>
                    <textarea id="concerns" name="concerns" rows="4" required><%=concern %></textarea>
                </div>
